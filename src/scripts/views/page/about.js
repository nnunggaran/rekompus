const About = {
  async render() {
    ...
    <section class="hero container-fluid row">
      <div class="col-sm-12 col-md-7 m-0 p-0 px-1 pe-2 my-2 mx-auto">
      ...
      <div class="col-sm-12 col-md-5 m-0 p-0 px-1 ps-2 my-2 mx-auto">
    ...
    <div class="container-fluid row mt-5">
      ...
      <hr>  
      <div class="col-sm-6 col-md-4 col-lg-3 m-0 p-0 px-1 my-1">
        <div class="card shadow">
          ...
          <div class="card-body" style="height: 240px;">
            ...
            <a href="https://www.linkedin.com/in/nosef-nunggaran/" class="btn btn-primary" target="_blank"><i class="fa-brands fa-linkedin fa-lg p-1"></i> </a>
            <a href="https://github.com/nnunggaran" class="btn btn-dark" target="_blank"><i class="fa-brands fa-github fa-lg p-1"></i> 
            </a>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-4 col-lg-3 m-0 p-0 px-1 my-1">
        <div class="card shadow">
          ...
          <div class="card-body" style="height: 240px;">
            ...
            <a href="https://www.linkedin.com/in/nurulhuda-jombang/" class="btn btn-primary" target="_blank"><i class="fa-brands fa-linkedin fa-lg p-1"></i> </a>
            <a href="https://github.com/rulhuda" class="btn btn-dark" target="_blank"><i class="fa-brands fa-github fa-lg p-1"></i> 
            </a>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-4 col-lg-3 m-0 p-0 px-1 my-1">
        <div class="card shadow">
          ...
          <div class="card-body" style="height: 240px;">
            ...
            <a href="https://www.linkedin.com/in/raihanputro/" class="btn btn-primary" target="_blank"><i class="fa-brands fa-linkedin fa-lg p-1"></i> </a>
            <a href="https://github.com/raihanputro" class="btn btn-dark" target="_blank"><i class="fa-brands fa-github fa-lg p-1"></i> 
            </a>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-4 col-lg-3 m-0 p-0 px-1 my-1">
        <div class="card shadow">
          ...
          <div class="card-body" style="height: 240px;">
            ...
            <p class="card-text">Berkontribusi dalam pengembangan Front-End Web dan Data Rekompus</p>
            <a href="https://www.linkedin.com/in/zahra-amalia-nur-sabrina-6a6468232/" class="btn btn-primary" target="_blank"><i class="fa-brands fa-linkedin fa-lg p-1"></i> </a>
            <a href="https://github.com/Zahraamalia" class="btn btn-dark" target="_blank"><i class="fa-brands fa-github fa-lg p-1"></i> 
            </a>
          </div>
        </div>
      </div>
