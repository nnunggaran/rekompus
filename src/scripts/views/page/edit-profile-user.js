        ...
        <div class="card border-orange bg-light">
          <div class="row alert-info m-3">
            ...
            <div class="col-md-5 p-3 my-auto">
              <a href="/#/dashboard/:id" class="link text-dark text-decoration-none border-bottom border-info border-2 fw-bold fs-5 py-2">
        ...
        <div class="card-body">
          ...
          <div class="card border-orange mb-3 alert-info">
            ...
            <div class="row p-2 align-items-center">
              ...
              <div class="col-sm-12 col-md-9">
                <input type="text" class="form-control border-orange w-100" id="asalSekolah" placeholder="Asal sekolah">
              </div>
            </div>
